...
const Block = () => {
  return (
    <>
      <header className="lgScreen:p-64 flex items-center p-12">
        <div className="logo text-violet">
          <FullLogo className="aspect-auto w-128" />
        </div>
      ...
      <main className="mt-32 px-64">
        <section className="hero-section relative grid h-fit">
          ...
          <div className="scroll-indicator m-0 bottom-0 absolute z-10 -mb-64 aspect-[1/2] w-32 self-end justify-self-center rounded-[9999px] border border-neutral-1200 shadow-inner"></div>
        </section>
                  ...
                  >
                    ...
                    <div className="mt-12 grid grid-flow-col gap-4 overflow-auto">
                      {mockIteratable(6).map((item, i) => (
                        <div
                          className="rounded-full bg-neutral-1400 px-16 py-8 text-sm text-white"
                          key={item + i}
                        >
                          React
                        </div>
        ...
        <section className="text-white">
          ...
          <div
            className="contact-form-container mt-24 grid place-content-around place-items-center"
            style={{
              gridTemplateColumns: 'max-content min-content'
            }}
          >
            <form className="flex min-w-[496px] flex-col gap-16 self-stretch">
              <input
                type="text"
                className="w-full rounded-sm border-2 border-green bg-neutral-1300"
                placeholder="Name"
              />
              <input
                type="email"
            ...
            <div className="flex min-w-[300px] flex-col items-center bg-neutral-1400 bg-opacity-50">
      ...
      <footer className="relative box-content flex gap-32 overflow-hidden bg-neutral-1400 p-32">
